...
<div className="flex flex-col justify-center items-center md:flex-row md:flex-wrap md:justify-center items-start gap-5 md:gap-12 lg:gap-[50px] xl:gap-[50px] w-full">
          ...
          <div className="flex flex-col gap-4 min-w-[200px] flex-1 md:flex-grow-0 md:text-center lg:text-left">
            ...
            <div className="flex flex-col gap-2 max-w-xs md:mx-auto lg:mx-0">
              ...
              />
              <button className="bg-white text-black py-2 px-4 rounded text-sm font-medium hover:bg-gray-100 transition-colors w-full">
                Subscribe
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 min-w-[150px] flex-1 md:flex-grow-0 md:text-center lg:text-left">
            ...
            <a href="#" className="text-sm text-gray-300 hover:text-white transition-colors">My Account</a>
            <a href="#" className="text-sm text-gray-300 hover:text-white transition-colors">Login / Register</a>
            <a href="#" className="text-sm text-gray-300 hover:text-white transition-colors">Cart</a>
            <a href="#" className="text-sm text-gray-300 hover:text-white transition-colors">Wishlist</a>
          ...
          <div className="flex flex-col gap-4 min-w-[150px] flex-1 md:flex-grow-0 md:text-center lg:text-left">
            ...
            <a href="#" className="text-sm text-gray-300 hover:text-white transition-colors">Terms of Use</a>
          ...
          <div className="flex flex-col gap-4 min-w-[220px] flex-1 md:flex-grow-0 md:text-center lg:text-left">
            ...
            <div className="flex flex-col gap-2 mt-2">
              <h4 className="text-sm font-medium text-center md:text-left lg:text-left">Follow Us</h4>
              <div className="flex gap-2 justify-center md:justify-start lg:justify-start">
                <a href="#" className="p-2 bg-gray-800 rounded hover:bg-gray-700 transition-colors">
                  <img 
                    src={facebookicon} 
                    alt="Facebook" 
